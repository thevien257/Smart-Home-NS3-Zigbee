...
## Tính năng mới trong NS-3.46

### Cải tiến trong NS-3.46
- Cải thiện build system: CMake-based build system mới
- API updates: Một số API có thể thay đổi so với version cũ
- Performance: Tối ưu hóa hiệu suất simulation
- Documentation: Tài liệu cập nhật và đầy đủ hơn

### Compatibility notes
- Kiểm tra API changes nếu code từ NS-3.36
- Cập nhật deprecated functions
- Test kỹ trước khi chạy batch simulations
...
- CC2530/CC2652 Datasheet (Texas Instruments)
...
### NS-3 Documentation
- [NS-3.46 Manual](https://www.nsnam.org/docs/release/3.46/manual/html/)
- [NS-3.46 Tutorial](https://www.nsnam.org/docs/release/3.46/tutorial/html/)
- [NS-3 Wiki](https://www.nsnam.org/wiki/)
- [NS-3 GitLab](https://gitlab.com/nsnam/ns-3-dev)
...
- **Your Name** - NS-3.46 Standalone Version

## Acknowledgments

- NS-3 Development Team
- ZigBee Alliance
- Contributors to the ZigBee module for NS-3
...
### Version 2.0 (NS-3.46 Standalone)
- Updated cho NS-3.46 standalone version
- File .cc đặt trong src/zigbee/examples/
- Scripts đặt trong thư mục gốc ns-3.46
- Thêm hướng dẫn chỉnh sửa CMakeLists.txt
- Loại bỏ icon/emoji

### Version 1.0 (NS-3.36 All-in-One)
- Initial release

**Happy Simulating with NS-3.46!**
